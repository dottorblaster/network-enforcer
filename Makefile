...
.PHONY: generate
generate: manifests controller-gen proto-agent ## Generate code containing DeepCopy, DeepCopyInto, and DeepCopyObject method implementations.
	"$(CONTROLLER_GEN)" object:headerFile="hack/boilerplate.go.txt" paths="./..."

.PHONY: proto-agent
proto-agent: ## Generate Go code from proto/agent/v1/agent.proto.
